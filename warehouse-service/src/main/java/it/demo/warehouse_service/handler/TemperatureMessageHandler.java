...
@Service
public class TemperatureMessageHandler implements SensorMessageHandler {

    private final SensorInformationProducer sensorInformationProducer;

    public TemperatureMessageHandler(SensorInformationProducer sensorInformationProducer) {
